  ...
  return (
    ...
    flex flex-col ml-1 ${isLargeOpen ? "lg:hidden" : "lg:flex"}`}
      ...
      {isSmallOpen && (
        <div
          onClick={close}
          className="lg:hidden fixed inset-0 z-[999] bg-secondary-dark
         opacity-50"
        />
      )}
      <aside
        className={`w-56 lg:sticky absolute top-0 overflow-y-auto
      scrollbar-hidden pb-4 lg:flex flex-col gap-2 px-2 ${
...
const LargeSidebarSection = ({
  ...
  const showExpandedButton = childenArray.length > visibleItemCount;
  const visibleChildren = isExpanded
    ? childenArray
    : childenArray.slice(0, visibleItemCount);
